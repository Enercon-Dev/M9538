...
public:
  ...
  virtual ErrorStatus Set_CommLossSetting(uint16_t Timeout, uint8_t Channels, uint8_t Mask) = 0;
  virtual ErrorStatus Get_CommLossSetting(uint16_t *Timeout, uint8_t *Channels, uint8_t *Mask) = 0;
