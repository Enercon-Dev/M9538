...
typedef struct {
  ...
  CommLoss_t            COMMLOSS;  
  Raw_Config_t          CHANNEL_CONFIG[NUM_OF_CBS];
  Por_Order_t           POR_ORDER[NUM_OF_CBS];
  DCI_Order_t           DCI_ORDER[NUM_OF_CBS]; 
} Config_Msg_T;        
#pragma pack(pop)
